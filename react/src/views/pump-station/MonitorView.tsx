...
const stations = [
    { id: 1, name: '朝阳路泵站', status: 'running', pumps: [{ id: 'P1', status: 'running', flow: 120, current: 32, temp: 45 }, { id: 'P2', status: 'running', flow: 115, current: 30, temp: 43 }, { id: 'P3', status: 'standby', flow: 0, current: 0, temp: 25 }], inletLevel: 2.8, outletLevel: 1.2, inletWarnLevel: 3.5, outletWarnLevel: 2.0, inFlow: 342, outFlow: 335, totalFlow: 342, alarms: 0 },
