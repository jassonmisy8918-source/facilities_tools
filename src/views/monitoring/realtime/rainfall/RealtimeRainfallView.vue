...
// ===================== 雨量计监测点 =====================
const gauges = ref([
    { id: 1, name: '和平路雨量站', value: 3.2, unit: 'mm/h', status: 'normal', updatedAt: '14:30:05' },
    { id: 2, name: '丰台区雨量站', value: 8.5, unit: 'mm/h', status: 'warning', updatedAt: '14:30:02' },
    { id: 3, name: '朝阳区雨量站', value: 1.8, unit: 'mm/h', status: 'normal', updatedAt: '14:29:58' },
    { id: 4, name: '海淀区雨量站', value: 0.4, unit: 'mm/h', status: 'normal', updatedAt: '14:30:01' },
    { id: 5, name: '通州区雨量站', value: 12.6, unit: 'mm/h', status: 'danger', updatedAt: '14:30:03' },
    { id: 6, name: '大兴区雨量站', value: 5.3, unit: 'mm/h', status: 'warning', updatedAt: '14:29:59' },
])
...
onMounted(() => {
    if (chartRef.value) {
        ...
        chart.setOption({
            ...
            series: [
                { name: '和平路', type: 'line', smooth: true, data: [0, 0.2, 0.8, 1.5, 2.1, 2.8, 3.0, 3.2, 3.1, 2.9, 3.0, 3.2], lineStyle: { width: 2 }, symbol: 'none' },
                { name: '丰台区', type: 'line', smooth: true, data: [1, 2, 3, 4.5, 5.8, 7.0, 8.0, 8.5, 8.2, 7.8, 8.0, 8.5], lineStyle: { width: 2 }, symbol: 'none' },
                { name: '通州区', type: 'line', smooth: true, data: [3, 4, 5.5, 7, 9, 10.5, 11.5, 12.6, 12.0, 11.5, 12.0, 12.6], lineStyle: { width: 2, color: '#EF4444' }, itemStyle: { color: '#EF4444' }, symbol: 'none' },
            ],
        })
